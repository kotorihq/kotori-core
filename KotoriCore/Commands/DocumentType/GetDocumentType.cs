...
namespace KotoriCore.Commands
{
    ...
    public class GetDocumentType : Command
    {
        ...
        /// <summary>
        /// Initializes a new instance of the GetDocumentType class.
        /// </summary>
        /// <param name="instance">Instance.</param>
        /// <param name="projectId">Project identifier.</param>
        /// <param name="documentType">Document type.</param>
        /// <param name="documentTypeId">Document type identifier.</param>
        public GetDocumentType(string instance, string projectId, Enums.DocumentType documentType, string documentTypeId)
        {
            Instance = instance;
            ProjectId = projectId;

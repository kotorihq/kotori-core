...
{
    /// <summary>
    /// Create document type transformations command.
    /// </summary>
    public class CreateDocumentTypeTransformations : Command
    {
        ...
        public CreateDocumentTypeTransformations(string instance, string projectId, string documentTypeId, string transformations)
        {
            Instance = instance;
            ProjectId = projectId;

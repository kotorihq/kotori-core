...
namespace KotoriCore
{
    ...
    public interface IKotori
    {
        ...
        SimpleDocument GetDocument(string instance, string projectId, string documentId, long? version = null, Enums.DocumentFormat format = Enums.DocumentFormat.Markdown);
        Task<SimpleDocument> GetDocumentAsync(string instance, string projectId, string documentId, long? version = null, Enums.DocumentFormat format = Enums.DocumentFormat.Markdown);
        ...
        string DeleteDocument(string instance, string projectId, string documentId);
        Task<string> DeleteDocumentAsync(string instance, string projectId, string documentId);
        ...
        SimpleDocumentType GetDocumentType(string instance, string projectId, string documentTypeId);
        Task<SimpleDocumentType> GetDocumentTypeAsync(string instance, string projectId, string documentTypeId);
        ...
        IEnumerable<SimpleDocumentVersion> GetDocumentVersions(string instance, string projectId, string documentId);
        Task<IEnumerable<SimpleDocumentVersion>> GetDocumentVersionsAsync(string instance, string projectId, string documentId);
        IEnumerable<DocumentTypeTransformation> GetDocumentTypeTransformations(string instance, string projectId, string documentTypeId);
        Task<IEnumerable<DocumentTypeTransformation>> GetDocumentTypeTransformationsAsync(string instance, string projectId, string documentTypeId);
        string CreateDocumentTypeTransformations(string instance, string projectId, string documentTypeId, string transformations);
        Task<string> CreateDocumentTypeTransformationsAsync(string instance, string projectId, string documentTypeId, string transformations);
        string UpsertDocumentTypeTransformations(string instance, string projectId, string documentTypeId, string transformations);
        Task<string> UpsertDocumentTypeTransformationsAsync(string instance, string projectId, string documentTypeId, string transformations);
        string CreateDocumentType(string instance, string projectId, string documentTypeId);
        Task<string> CreateDocumentTypeAsync(string instance, string projectId, string documentTypeId);
        string UpsertDocumentType(string instance, string projectId, string documentTypeId);
        Task<string> UpsertDocumentTypeAsync(string instance, string projectId, string documentTypeId);
        string DeleteDocumentType(string instance, string projectId, string documentTypeId);
        Task<string> DeleteDocumentTypeAsync(string instance, string projectId, string documentTypeId);
    }
}

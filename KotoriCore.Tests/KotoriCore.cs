...
namespace KotoriCore.Tests
{
    ...
    public class KotoriCore
    {
        ...
        public void CreateDocumentTypeTransformations()
        {
            ...
            Assert.AreEqual("/api/projects/lalala/content/hm", res.Url);
            ...
            Assert.AreEqual("hm", res.Id);
            Assert.AreEqual("/api/projects/lalala/content/hm/transformations", res.Url);
            Assert.IsTrue(res.NewResource);
        ...
        public async Task Complex()
        {
            ...
            Assert.IsTrue(d.Content.IndexOf("## 0101000010101010010101 and btw rating is 10 for The Matrix", StringComparison.InvariantCulture) != -1);
...
---");
        ...
        public void DraftAndNonDraft()
        {
            ...
            Assert.AreEqual("/api/projects/drnodr/content/x/documents/a", r1.Url);
            ...
            Assert.AreEqual("/api/projects/drnodr/content/x/documents/a", r2.Url);
...
---";
            ...
            Assert.AreEqual("2", res.Id);
            Assert.AreEqual("/api/projects/data-woho/data/newgame/indices/2", res.Url);
            Assert.IsTrue(res.NewResource);
...
";
        ...
        public async Task CreateProjectWithGeneratedId()
        {
            ...
            Assert.AreEqual($"/api/projects/{res.Id}/content/movies/documents/{res2.Id}", res2.Url);
